 ...
 */
 ...
 #include "images.h"  // Include custom images
  ...
  const char* url1 = "/apps/thinghttp/send_request?api_key=VA6XW0KDUUIORXS5";     //Change this URL Cases
  const char* url2 = "/apps/thinghttp/send_request?api_key=EZO8BN45HKT4Y3PZ";   //Deaths
  const char* url3 = "/apps/thinghttp/send_request?api_key=EF8MP9WEYREQ5TDS";   //Recovered
